/* 
 * Credits to alexguirre for this class.
 * https://gist.github.com/alexguirre/f3f47f75ddcf617f416f3c8a55ae2227
 */
namespace ResponseVLib
{
    public static class DamagePacks
    {
        public static void ApplyDamagePack(this Rage.Ped ped, string damagePackName, float damage, float multiplier)
        {
            Rage.Native.NativeFunction.Natives.ApplyPedDamagePack(ped, damagePackName, damage, multiplier);
        }
